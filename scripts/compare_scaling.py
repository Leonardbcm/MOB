...
p41 = {
    ...
    "store_OBhat" : os.path.join(model_wrapper.folder(), "Forecasts", "P41"),    
    "transformer" : "",
    "scale" : "Clip-Sign",
    "weight_initializers" : [BiasInitializer("normal", 30, 40, -500, 3000), ],
}
...
p42 = {
    ...
    "store_OBhat" : os.path.join(model_wrapper.folder(), "Forecasts", "P42"),    
    "transformer" : "Standard",
    "scale" : "Clip-Sign",
    "weight_initializers" : [BiasInitializer("normal", 30, 40, -500, 3000), ],
}
...
######################### Analyse train distributions for the first epoch
parameters = p42
param_temps = copy.deepcopy(params)
param_temps.update(parameters)
ploter = MultiplePlotter(
...
ploter.scaling_summary(regrs["P42"], Y)
...
for parameters, name in zip([p12, p31],
    ...
    param_temps["store_val_OBhat"] = False
    param_temps["store_OBhat"] = False    
